...
<template>
    <div class="bg-white rounded-xl shadow p-4 border">
        ...
        <transition name="fade" mode="out-in">
            <table v-if="paginatedShipments.length" key="table"
                ...
                <tbody>
                    <tr v-for="s in paginatedShipments" :key="s.id"
                        ...
                        <td class="px-4 py-2">
                            <button @click="editShipment(s)" class="text-purple-600 hover:underline text-sm"
                                title="Редактировать">
                                ✏️
                            </button>
                        </td>
